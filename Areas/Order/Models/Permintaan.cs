...
{
    [Table("OrdPermintaan", Schema = "dbo")]
    public class Permintaan : AktivitasPengguna
    {
        [Key]
    ...
    [Table("OrdPermintaanDetail", Schema = "dbo")]
    public class PermintaanDetail : AktivitasPengguna
    {
        [Key]
        public Guid PermintaanDetailId { get; set; }
        public Guid PermintaanId { get; set; }
